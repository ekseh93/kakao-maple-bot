...
## 2026-09-08 날씨 초단순 응답 경로

- 대기질 API와 Nominatim fallback 지오코더를 제거했습니다. 이제 `!날씨`는 Open-Meteo Geocoding 1회(캐시 미스 시)와 Forecast 1회만 호출합니다.
- PM10·PM2.5 출력도 제거해 외부 요청과 응답 줄 수를 줄였습니다. 결과는 지역·상태·기온·습도만 반환합니다.

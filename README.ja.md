...
`!정보 <ニックネーム>`, `!무릉 <ニックネーム>`, `!유니온 <ニックネーム>`, `!유챔 <ニックネーム>`, `!장비 <ニックネーム>`, `!경험치 <ニックネーム>`, `!심볼 <地域> <開始> <目標>`, `!심볼만렙`, `!보스`, `!보스수익 <ボス> <難易度> [人数]`, `!보스보상`, `!보스렙뻥`, `!보스포뻥`, `!메카베리 <レベル>`, `!메포효율`, `!공지`, `!이벤트`, `!썬데이`, `!선데이`, `!인벤`, `!마빡도로시`, `!디코`を提供します。

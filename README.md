...
| 예약 리마인더 | 매주 수요일 22:30·23:00 수로·플래그 문구             | 명시적 동의 방에 한정한 phone relay 발신        |
...
`!명령어 도움말` 또는 `!명령어 help`를 입력하면 해당 명령어의 형식과 예시를 확인할 수 있습니다. `!다나와 도움말`은 다나와 견적·부품 검색·최저가·가격비교·가격이력·상세·호환성 명령어를 한 번에 안내합니다. 배포 변경은 [변경 기록](docs/14-change-log.md)에, 장애·검증 과정은 [트러블슈팅 기록](docs/13-troubleshooting.md)에 계속 기록합니다.
...
- [App Runner 권한 요청서](docs/20-apprunner-access-request.md)

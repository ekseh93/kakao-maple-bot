...
| 진행 중 이벤트              | !이벤트                               | 메이플스토리 공식 진행 중 이벤트 페이지(최신 10개)    |
| 썬데이 메이플               | !썬데이 / !선데이                     | Nexon Open API 공지 목록                              |
| 인벤 10추글                 | !인벤                                 | 메이플 인벤 공개 10추 게시판                          |
| 퀘이사존 핫딜               | !핫딜                                 | 퀘이사존 최신 핫딜 10개                               |
| 퀘이사존 그래픽카드         | !글카                                 | 그래픽카드 게시판 최신 글 5개                         |
| 디시인사이드 모니터         | !모니터                               | 모니터 갤러리 최신 글 10개                            |
| 디시인사이드 일본여행       | !일본여행기                           | 일본여행 갤러리 최신 글 5개                           |
| 디시인사이드 일본 음식점    | !일본음식점                           | 일본 음식점 최신 글 5개                               |
...
| 일본 만화 추천              | !만화                                 | 나무위키 일본 만화 목록 랜덤 추천                     |
| 오늘의 운세                 | !운세 1993-08-15 남자 양력            | fortuneteller 참고형 로컬 운세 어댑터, 외부 호출 없음 |
...
| 통합 상품 비교              | !상품비교 상품                        | 다이소·편의점 공개 조회 facade                        |
| 매장 검색                   | !매장 브랜드 지역                     | 다이소·올리브영·편의점·롯데마트 조회                  |
| 다이소 재고                 | !재고 다이소 상품 지역                | 상품 검색 후 다이소 재고 조회                         |
| 영화관 검색                 | !영화관 지역                          | CGV·메가박스·롯데시네마 조회                          |
| 전국 평균 유가              | !기름 / !유가                         | 한국석유공사 오피넷 전국 평균                         |
| 전국 최저가 주유소          | !주유소                               | 한국석유공사 오피넷 최저가 3곳                        |
| 달러·엔화 환율              | !환율                                 | 무료 공개 환율 조회                                   |
| 주변 장소 검색              | !주변 지역 [카테고리]                 | 음식점·카페 등 주변 장소                              |
| 다이소 상품 상세            | !상품상세 상품ID                      | 가격·품절·신상품 상태                                 |
